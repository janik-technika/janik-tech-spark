...
const g11 = "/lovable-uploads/85a28d4c-f584-4a6f-8a36-8315a3a282de.png";
const g12 = "/lovable-uploads/6465d6b4-d7b4-4580-a927-95f1f2c3071b.png";
const g13 = "/lovable-uploads/737c796e-7f78-46f8-99f0-f980c28c783a.png";
const g14 = "/lovable-uploads/c05956e5-15cc-44b0-820d-9eb318695760.png";
const g15 = "/lovable-uploads/2bf1a65c-5e86-414e-95c3-0f9e13f69100.png";
const g16 = "/lovable-uploads/dfbfe532-ba53-46d7-a0ec-105433d5acf6.png";
const g17 = "/lovable-uploads/12fbdf18-afb3-4e83-8a58-b123dbeb35d9.png";
const g18 = "/lovable-uploads/a3d230a6-4b69-4c2b-968c-a2447cceb834.png";
const g19 = "/lovable-uploads/d46fad76-0f10-46fc-9448-7392db7cb240.png";
const g20 = "/lovable-uploads/21516b2f-ad78-4f37-bfd6-42b327555683.png";
const g21 = "/lovable-uploads/9545e903-38db-4652-b402-e021a044b5db.png";
const g22 = "/lovable-uploads/80b67dd8-2af1-42e5-882b-5f8ff21ec1ad.png";
        ...
        <section id="onas" aria-labelledby="onas-title">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <article className="md:col-span-2 glass rounded-xl p-6 leading-relaxed space-y-4">
              ...
              <p>Od samého začátku Vám nabízíme stroje od největšího světového výrobce této techniky STIHL. Sám osobně jsem skálopevně přesvědčen, že je to v tomto segmentu ta nejkvalitnější značka, kterou si můžete dopřát. Dále si u nás můžete pořídit techniku značek STIGA, MAKITA, DAKR, Fiskars a další, u kterých garantujeme prvotřídní kvalitu a spolehlivost.</p>
              <p>Nikdy nebudeme prodávat výrobky pochybné kvality, u kterých by nebyla zajištěna odpovídající servisní podpora a které jsou spíše pro potíže, než pro užitek. Takový segment milerádi přenecháme i nadále trhovcům, hobbymarketům a všem různým „specialistům a expertům na zahrady". Taky jste si všimli, že podle reklam v médiích, je dnes kde kdo odborníkem na lesní a zahradní techniku? Že je najednou spousta „značek" o kterých nikdo předtím neslyšel, ale snaží se navodit dojem, že s nimi pracuje celý svět? Tak toho se u nás bát rozhodně nemusíte, protože není celosvětově známější značka, než námi zastupovaný legendární STIHL.</p>
              <p>Ať už potřebujete profesionální pilu pro každodenní mnohahodinovou práci, nebo pilu pro použití kolem domu, ať potřebujete sekačku, robota, či traktor na sekání trávníku, nebo chcete upravovat živé ploty, prostě na všechny práce v lese, či na zahradě, jste u nás na té správné adrese.</p>
            </article>
